//Generated:2021-12-20 21:08:13// 39-518
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
    ...
    replaceMacros: function(str, cb) {
      ...
      ftqsMacros.forEach(function(ftqsMacro) {
        var ftqsMacroKey = ftqsMacro.replace("[ftqs:[", "").replace("]]", "");
        var ftqsMacroValue = false;
        if (ftqsMacroKey && o.params) {
          ftqsMacroValue = o.params.split("&").filter(function(param) { 
            return param.indexOf(ftqsMacroKey) > -1; 
          }).map(function(param) { 
        ...
        if (ftqsMacroKey) {
          var keyRegExp = new RegExp(backSlash + "[ftqs:" + backSlash + "[" + ftqsMacroKey + backSlash + "]" + backSlash + "]", "g");
          str = str.replace(keyRegExp, ftqsMacroValue);
        }
      });
    ...
    receive: function(e) {
      ...
      if (!o.serveDOM || /^https?:\/\/[a-z0-9\-\.]*flashtalking\.(com|net|dev)/i.test(e.origin.toString()) || o.adWindow === e.source) {
        if (o.apiVersion && o.apiVersion.major === 0 && info.msg && info.msg.version) {
          version = String(info.msg.version).split('.');
          for (var i = 0; i < version.length; i++) {
            o.apiVersion[!i ? 'major' : i === 1 ? 'minor' : 'patch'] = parseInt(version[i], 10) || 0;
          }
        }
        if (info.method && info.method === 'ready' && info.msg && info.msg.location && info.msg.location.indexOf(o.file) > -1) {
          o.adWindow = e.source;
        }
  ...
  var data = {
    params: window.ftParams_5183710 || '',
    GUID: window.ftGUID_5183710 || '99999999999',
    confID: window.ftConfID_5183710 || '0',
    ftReturn: window.ftReturn_5183710 || '',
    keyword: window.ftKeyword_5183710 || '',
    ftId: window.ftId_5183710 || '',
    imp: window.ftImp5183710,
    ftImpId: window.ftImp5183710 && window.ftImp5183710.impID || '',
    gdpr: window.ftImp5183710 && window.ftImp5183710.gdpr || '',
    gdpr_consent: window.ftImp5183710 && window.ftImp5183710.gdpr_consent || '',
    gdpr_pd: window.ftImp5183710 && window.ftImp5183710.gdpr_pd || '',
    us_privacy: window.ftImp5183710 && window.ftImp5183710.us_privacy || '',
    campaignID: '140402',
    cID: '110416',
    pID: '5183710',
    creativeID: '3682297',
    exttrack: [
      'https://dpm.demdex.net/ibs:dpid=3047&dpuuid=[%FT_GUID%]&','https://d.agkn.com/pixel/4068/?che=[%FT_RANDOM%]&aid=12345&cvid=[%FT_CONFID%]&cd1=[%esid!]&cd2=[%epid!]&col=140402,6060,5183710,0,3682297,[%FT_IMPRESSIONID%],[%IDFA%]&puid=[%FT_GUID%]'
    ],
    extscript: [
      ""
    ],
    clickTags: [
      "http://servedby.flashtalking.com/click/8/140402;5183710;3682297;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://d.agkn.com/pixel/4069/?che=[%FT_RANDOM%]&aid=12345&cvid=[%FT_CONFID%]&cd1=[%esid!]&cd2=[%epid!]&col=140402,6060,5183710,0,3682297,[%FT_IMPRESSIONID%],[%IDFA%]&l0=https://www.xfinity.com/gig?dfaid=4053494&cmp=0&cid=4053494"
    ],
    placementDescription: 'CORPQ12021BAUNEDNONDT5183710FT728x90',
    width: 728,
    height: 90,
    ...
    divID: 'ftdiv5183710',
    phID: 'ftpos5183710',
    frameID: 'ftframe5183710',
    expID: 'ftexpframe5183710',
    altImgID: 'ftalt5183710',
    altText: 'Click here',
    altImgTarget: '_blank',
    altimghref: 'http://servedby.flashtalking.com/click/8/140402;5183710;3682297;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://d.agkn.com/pixel/4069/?che=[%FT_RANDOM%]&aid=12345&cvid=[%FT_CONFID%]&cd1=[%esid!]&cd2=[%epid!]&col=140402,6060,5183710,0,3682297,[%FT_IMPRESSIONID%],[%IDFA%]&l0=https://www.xfinity.com/gig?dfaid=4053494&cmp=0&cid=4053494',
    altImg: 'http://servedby.flashtalking.com/imp/8/140402;5183710;204;gif;XfinityUS;CORPQ12021BAUNEDNONDT5183710FT728x90/?',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/140402;5183710;271;pixel;XfinityUS;CORPQ12021BAUNEDNONDT5183710FT728x90/?',
    stump: 'http://servedby.flashtalking.com',
    jsurl: 'http://cdn.flashtalking.com/xre/518/5183710/3682297/js/j-5183710-3682297.js',
    file: 'http://cdn.flashtalking.com/110416/3682297/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM: 'http://cdn.flashtalking.com',
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?217238317-5183710;3682297;',
    adVis: false ? 1 : 0,
    centreAd: false,
    mvt: true,
    segment: window.ftSegment_5183710 || '',
    segmentList: window.ftSegmentList_5183710 || [],
    ...
    baggyFrameLimit: 15,
    append: !!(window.ftImp5183710 && window.ftImp5183710.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m5183710') && /^https:/.test(document.getElementById('ftscript_m5183710').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m5183710'),
    ...
    qsVars: [
      ['ftguid', 'ftGUID_5183710'],
      ['ftcfid', 'ftConfID_5183710'],
      ['fttime', 'ftTimestamp_5183710'],
      ['ftsection', 'ftSection_5183710'],
      ['ftcustom', 'ftCustom_5183710'],
      ['ft_id', 'ftId_5183710'],
      ['ftimpid', 'ftImp5183710', 'impID'],
      ['gdpr', 'ftImp5183710', 'gdpr'],
      ['gdpr_consent', 'ftImp5183710', 'gdpr_consent'],
      ['gdpr_pd', 'ftImp5183710', 'gdpr_pd'],
      ['us_privacy', 'ftImp5183710', 'us_privacy']
    ]
  };
  ...
  //--start extensions
//segment parser start
ft5183710.addEventListener("start",function(){
  //var usrSegs= "u0r,u0u,uyt,123".split(','),
  var usrSegs = (window.ftSegment_5183710 !== "") ? window.ftSegment_5183710.split(","): [],
   matched = [],
   getCCSegs = getCCSegs();
...
function getCCSegs(){
 ...
 function matchSegs(CC){
   ...
   //fire 402 stateCall
    // var img = new Image();
    // img.src = "https://servedby.flashtalking.com/state/"+o.pID+";"+o.creativeID+";"+o.confID+";402;"+o.ftImpId+"/?ft_product="+matched+"&cachebuster="+o.random();
  };
});
//segment parser end
//macro JSE start
o.replaceMacros= function(str, cb) {
        var noCache, hasRandom, map = {
            ...
            GUID: window['ftGUID_' + o.pID],
            IDFA: o.ftId,
            SECTION: window['ftSection_' + o.pID],
            CUSTOM: window['ftCustom_' + o.pID],
            RANDOM: o.random(),
            CONFID: window['ftConfID_' + o.pID],
            NOCACHEBUSTER: '',
            IMPRESSIONID: o.ftImpId,
            CONTENT: o.decode(o.qs('ftscw', '')),
            PROTOCOL: o.secure ? 'https' : 'http',
            EBUY: window.ebuy,
            ESID: window.esid,
            EPID: window.epid,
            ...
            ERID: window.erid,
            EAID: window.eaid,
            EEXCID: window.eexcid,
            EEXPID: window.eexpid,
            ERV: window.erv,
            EIID: window.eiid
        },
        allMacros = /(?:\[|%5B|%255B)(%|%25|%2525)?(?:FT_)?(?:\W*)?(\w+)?(?:\W*)\1(?:\]|%5D|%255D)/gi,
        replacer = function($0, d, macro) {
            macro = macro.toUpperCase();
            if (macro === 'NOCACHEBUSTER'){
              noCache = true;
